...
<a href="/v1/admin/users/register" class="btn btn-primary float-end">
		...
		{#key users}
			{#each users as user}
				<tr class="align-middle">
					...
					<td>
						<a href="/v1/admin/users/{user.id}" class="btn btn-light">
							<i class="bi-info-circle" /> Info
						</a>
						<a href="/v1/admin/users/{user.id}/edit" class="btn btn-primary">
