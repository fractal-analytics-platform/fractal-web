<script>
	...
	import ProjectDatasetsList from '$lib/components/v1/projects/ProjectDatasetsList.svelte';
	import WorkflowsList from '$lib/components/v1/projects/WorkflowsList.svelte';
