...
<hr />
<p>
	Some of the requested tasks are not available on this Fractal instance. You can collect missing
	task packages at the <a href="/v2/tasks/management">Tasks management</a> page, or select one of the
...
{#each workflowImportErrorData ?? [] as data, index (index)}
	...
	<section class="task-to-import">
		<div style="display: flex; align-items: center; gap: 8px;">
			<div>
				<BooleanIcon value={data.outcome === 'success' || selectedVersions[index] !== undefined} />
			</div>
			<div>
		...
		<div>
			{#if data.outcome !== 'success'}
				...
				{:else}
					...
					You should collect the task package at the
					<a href="/v2/tasks/management">Tasks management</a>
