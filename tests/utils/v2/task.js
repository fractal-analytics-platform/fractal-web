...
export async function checkTasksOrder(page, ...expectedNames) {
	...
	await expect(tasksListContainer.locator('.wft-item-btn')).toHaveCount(expectedNames.length);
	const names = await tasksListContainer.locator('.wft-item-btn').allInnerTexts();
