---
title: <Page name as it appears in Fractal web>
description: <One sentence describing what this page lets the user do.>
---
...
<!--
CONCEPT BOX  —  copy this block verbatim onto any page that touches the concept.
...
- Concept: [<Concept>](../concepts/<slug>.md)
- Reference: [<Adjacent page>](<page>.md)
