...
```
includes/concepts/    Canonical concept summaries (2–4 sentences). Single source
...
1. Copy `_templates/concept-snippet.md` → `includes/concepts/<slug>.md` and write
   the 2–4 sentence summary. This is the only place the wording lives.
2. Copy `_templates/explanation-page.md` → `docs/concepts/<slug>.md`. It already
